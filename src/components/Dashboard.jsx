...
const features = [
  { title: "Adopt a Pet", icon: <Pets sx={{ fontSize: 50, color: "#5D4037" }} />, description: "Find and adopt your perfect pet." },
  { title: "Shop for Pets", icon: <Store sx={{ fontSize: 50, color: "#5D4037" }} />, description: "Buy pet essentials and accessories." },
  { title: "Donate & Help", icon: <VolunteerActivism sx={{ fontSize: 50, color: "#5D4037" }} />, description: "Support shelters and pet welfare." },
