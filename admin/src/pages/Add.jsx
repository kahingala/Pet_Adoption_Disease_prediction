        ...
        <div className='flex gap-3'>
          <div onClick={() => setSizes(prev => prev.includes("1kg") ? prev.filter(item => item !== "1kg") : [...prev, "1kg"])}>
            <p
              ...
              style={{
                backgroundColor: sizes.includes("1kg") ? "#d4c49e" : "#e2e8f0", // #e2e8f0 = slate-200
              }}
            >
              1kg
            </p>
          ...
          <p
              ...
              style={{
                backgroundColor: sizes.includes("5kg") ? "#d4c49e" : "#e2e8f0", // #e2e8f0 = slate-200
              }}
            >
              5kg
            </p>
          ...
          <p
              ...
              style={{
                backgroundColor: sizes.includes("12kg") ? "#d4c49e" : "#e2e8f0", // #e2e8f0 = slate-200
              }}
            >
              12kg
            </p>
